import os
from llm import LLM_CUDA_AWQ, PerfStreamer
import torch
import psutil
from llm_models import HF_LLAMA_3_8B_INSTRUCT, AWQ_LLAMA_3_8B_INSTRUCT
...
def main():
    llm = LLM_CUDA_AWQ(HF_LLAMA_3_8B_INSTRUCT, AWQ_LLAMA_3_8B_INSTRUCT, SYSTEM_PROMPT)
    for k in range(3):
        ctx = llm.getContext()
