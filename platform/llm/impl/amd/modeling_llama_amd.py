...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if not return_dict:
            ...
            logging.critical(f"[PROFILE][LLAMAAMD] model_decoder_forward {decoder_time} {preprocessing_time} {postprocessing_time}")
    ...
    def prepare_inputs_for_generation(
        ...
        # print ("past_key_values: ", past_key_values[0][0].shape, past_key_values[1][0].shape, )
